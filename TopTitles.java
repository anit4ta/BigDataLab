...
// <<< Don't Change
    ...
    public static class TopTitlesMap extends Mapper<Text, Text, NullWritable, ConstSizeRanking> {
        Integer N;
    ...
    public static class TopTitlesReduce extends Reducer<NullWritable, ConstSizeRanking, Text, IntWritable> {
        Integer N;
